...
1. Navigate to the **GitHub repository** of [the project](https://github.com/Seddryck/Danaid).
...
Example:
   ...
   ```powershell
   https://github.com/Seddryck/Danaid/releases/download/v0.13.0/Danaid-0.13.0-net7.0-win-x64.zip
   ```
