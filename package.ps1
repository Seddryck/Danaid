...
$projects = @(
  "src/Danaid.Core/Danaid.Core.csproj",
  "src/Danaid.Cli/Danaid.Cli.csproj"
)
    ...
    foreach ($framework in $frameworks) {
        foreach ($runtime in $runtimes) {
            ...
            if ($project -like "*Danaid.Cli*") {
                ...
                7z a ./.publish/Danaid-$env:GitVersion_SemVer-$framework-$runtime.zip ./.publish/$framework/$runtime/*.*
            }
        }
    }
